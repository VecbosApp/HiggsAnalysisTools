...
do
	...
	if [ -e $head$mass".comb_0j"$tail ] && [ -e $head$mass".comb_1j"$tail ] && [ -e $head$mass".of_2j"$tail ] && [ -e $head$mass".sf_2j"$tail ]
	then
		echo " $mass: comb_0j comb_1j of_2j sf_2j => comb_0j1j2j "
		$combCmd HWW_0j=$head$mass".comb_0j"$tail HWW_1j=$head$mass".comb_1j"$tail HWW_2j_of=$head$mass".of_2j"$tail HWW_2j_sf=$head$mass".sf_2j"$tail > $head$mass.comb_0j1j2j$tail
fi
