...
public:
 ...
 std::string getSignalCBMeanString(int ch) {
  ...
  void createCard(float mass, float mrMin, float mrMax, int ch) {
    ...
    card = cp.updateCardShapeUncertainty(card, ("BKG_QQWW_"+chstr+tevstr+"_sigma_err_scaleup-qcd"),   cp.getRelUncertainty(getStringFitChannel(ch),"qqWWMCatNLONom","qqWWMCatNLOUp","si","nominals","nominals"));
    card = cp.updateCardShapeUncertainty(card, ("BKG_QQWW_"+chstr+tevstr+"_mean_err_scaledn-qcd"),    cp.getRelUncertainty(getStringFitChannel(ch),"qqWWMCatNLONom","qqWWMCatNLODown","me","nominals","nominals"));
    ...
    card = cp.updateCardShapeUncertainty(card, ("BKG_QQWW_"+chstr+tevstr+"_sigma_err_scaleup-e"),     cp.getRelUncertainty(getStringFitChannel(ch),"qqWWMadgraph","si","scaleup-e"));
    card = cp.updateCardShapeUncertainty(card, ("BKG_QQWW_"+chstr+tevstr+"_mean_err_scaledn-e"),      cp.getRelUncertainty(getStringFitChannel(ch),"qqWWMadgraph","me","scaledn-e"));
    card = cp.updateCardShapeUncertainty(card, ("BKG_QQWW_"+chstr+tevstr+"_sigma_err_scaledn-e"),     cp.getRelUncertainty(getStringFitChannel(ch),"qqWWMadgraph","si","scaledn-e"));
    card = cp.updateCardShapeUncertainty(card, ("BKG_QQWW_"+chstr+tevstr+"_mean_err_scaleup-m"),      cp.getRelUncertainty(getStringFitChannel(ch),"qqWWMadgraph","me","scaleup-m"));
    card = cp.updateCardShapeUncertainty(card, ("BKG_QQWW_"+chstr+tevstr+"_sigma_err_scaleup-m"),     cp.getRelUncertainty(getStringFitChannel(ch),"qqWWMadgraph","si","scaleup-m"));
    card = cp.updateCardShapeUncertainty(card, ("BKG_QQWW_"+chstr+tevstr+"_mean_err_scaledn-m"),      cp.getRelUncertainty(getStringFitChannel(ch),"qqWWMadgraph","me","scaledn-m"));
    card = cp.updateCardShapeUncertainty(card, ("BKG_QQWW_"+chstr+tevstr+"_sigma_err_scaledn-m"),     cp.getRelUncertainty(getStringFitChannel(ch),"qqWWMadgraph","si","scaledn-m"));
    card = cp.updateCardShapeUncertainty(card, ("BKG_QQWW_"+chstr+tevstr+"_mean_err_scaleup-j"),      cp.getRelUncertainty(getStringFitChannel(ch),"qqWWMadgraph","me","scaleup-j"));
    card = cp.updateCardShapeUncertainty(card, ("BKG_QQWW_"+chstr+tevstr+"_sigma_err_scaleup-j"),     cp.getRelUncertainty(getStringFitChannel(ch),"qqWWMadgraph","si","scaleup-j"));
    card = cp.updateCardShapeUncertainty(card, ("BKG_QQWW_"+chstr+tevstr+"_mean_err_scaledn-j"),      cp.getRelUncertainty(getStringFitChannel(ch),"qqWWMadgraph","me","scaledn-j"));
    card = cp.updateCardShapeUncertainty(card, ("BKG_QQWW_"+chstr+tevstr+"_sigma_err_scaledn-j"),     cp.getRelUncertainty(getStringFitChannel(ch),"qqWWMadgraph","si","scaledn-j"));

    card = cp.updateCardShapeUncertainty(card, ("BKG_GGWW_"+chstr+tevstr+"_mean_err_res-met"),        cp.getRelUncertainty(getStringFitChannel(ch),"ggWW","me","res-met"));
    ...
    card = cp.updateCardShapeUncertainty(card, ("BKG_GGWW_"+chstr+tevstr+"_sigma_err_scaledn-e"),     cp.getRelUncertainty(getStringFitChannel(ch),"ggWW","si","scaledn-e"));
    card = cp.updateCardShapeUncertainty(card, ("BKG_GGWW_"+chstr+tevstr+"_mean_err_scaleup-m"),      cp.getRelUncertainty(getStringFitChannel(ch),"ggWW","me","scaleup-m"));
    card = cp.updateCardShapeUncertainty(card, ("BKG_GGWW_"+chstr+tevstr+"_sigma_err_scaleup-m"),     cp.getRelUncertainty(getStringFitChannel(ch),"ggWW","si","scaleup-m"));
    card = cp.updateCardShapeUncertainty(card, ("BKG_GGWW_"+chstr+tevstr+"_mean_err_scaledn-m"),      cp.getRelUncertainty(getStringFitChannel(ch),"ggWW","me","scaledn-m"));
    card = cp.updateCardShapeUncertainty(card, ("BKG_GGWW_"+chstr+tevstr+"_sigma_err_scaledn-m"),     cp.getRelUncertainty(getStringFitChannel(ch),"ggWW","si","scaledn-m"));
    card = cp.updateCardShapeUncertainty(card, ("BKG_GGWW_"+chstr+tevstr+"_mean_err_scaleup-j"),      cp.getRelUncertainty(getStringFitChannel(ch),"ggWW","me","scaleup-j"));
    card = cp.updateCardShapeUncertainty(card, ("BKG_GGWW_"+chstr+tevstr+"_sigma_err_scaleup-j"),     cp.getRelUncertainty(getStringFitChannel(ch),"ggWW","si","scaleup-j"));
    card = cp.updateCardShapeUncertainty(card, ("BKG_GGWW_"+chstr+tevstr+"_mean_err_scaledn-j"),      cp.getRelUncertainty(getStringFitChannel(ch),"ggWW","me","scaledn-j"));
    card = cp.updateCardShapeUncertainty(card, ("BKG_GGWW_"+chstr+tevstr+"_sigma_err_scaledn-j"),     cp.getRelUncertainty(getStringFitChannel(ch),"ggWW","si","scaledn-j"));
    ...
    card = cp.updateCardShapeUncertainty(card, ("BKG_TOP_"+chstr+tevstr+"_sigma_err_scaledn-j"),     cp.getRelUncertainty(getStringFitChannel(ch),"Top","si","scaledn-j"));
    ...
    card = cp.updateCardShapeUncertainty(card, ("BKG_WGSTAR_"+chstr+tevstr+"_sigma_err_scaledn-e"),     cp.getRelUncertainty(getStringFitChannel(ch),"WGstar","si","scaledn-e"));
    card = cp.updateCardShapeUncertainty(card, ("BKG_WGSTAR_"+chstr+tevstr+"_mean_err_scaleup-m"),      cp.getRelUncertainty(getStringFitChannel(ch),"WGstar","me","scaleup-m"));
