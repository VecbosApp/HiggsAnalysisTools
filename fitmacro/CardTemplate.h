...
std::string createCardTemplate(int channel, bool do1D, std::string workspacefilename) {
    ...
    if (channel == of0j || channel == of1j) {
      card += "sig_"+chstr+"_8TeV_mean_err_res-met        param    0    SIG_"+chstr+"_8TeV_mean_err_res-met      [-3,3]    \n";
      card += "sig_"+chstr+"_8TeV_sigma_err_res-met       param    0    SIG_"+chstr+"_8TeV_sigma_err_res-met     [-3,3]    \n";
      card += "sig_"+chstr+"_8TeV_alpha_err_res-met       param    0    SIG_"+chstr+"_8TeV_alpha_err_res-met     [-3,3]    \n";
      card += "sig_"+chstr+"_8TeV_n_err_res-met           param    0    SIG_"+chstr+"_8TeV_n_err_res-met         [-3,3]    \n";
      card += "sig_"+chstr+"_8TeV_mean_err_res-e          param    0    SIG_"+chstr+"_8TeV_mean_err_res-e        [-3,3]    \n";
      card += "sig_"+chstr+"_8TeV_sigma_err_res-e         param    0    SIG_"+chstr+"_8TeV_sigma_err_res-e       [-3,3]    \n";
      card += "sig_"+chstr+"_8TeV_alpha_err_res-e         param    0    SIG_"+chstr+"_8TeV_alpha_err_res-e       [-3,3]    \n";
      card += "sig_"+chstr+"_8TeV_n_err_res-e             param    0    SIG_"+chstr+"_8TeV_n_err_res-e           [-3,3]    \n";
      card += "sig_"+chstr+"_8TeV_mean_err_scaleup-e      param    0    SIG_"+chstr+"_8TeV_mean_err_scaleup-e    [-3,3]    \n";
      card += "sig_"+chstr+"_8TeV_sigma_err_scaleup-e     param    0    SIG_"+chstr+"_8TeV_sigma_err_scaleup-e   [-3,3]    \n";
      card += "sig_"+chstr+"_8TeV_alpha_err_scaleup-e     param    0    SIG_"+chstr+"_8TeV_alpha_err_scaleup-e   [-3,3]    \n";
      card += "sig_"+chstr+"_8TeV_n_err_scaleup-e         param    0    SIG_"+chstr+"_8TeV_n_err_scaleup-e       [-3,3]    \n";
      card += "sig_"+chstr+"_8TeV_mean_err_scaledn-e      param    0    SIG_"+chstr+"_8TeV_mean_err_scaledn-e    [-3,3]    \n";
      card += "sig_"+chstr+"_8TeV_sigma_err_scaledn-e     param    0    SIG_"+chstr+"_8TeV_sigma_err_scaledn-e   [-3,3]    \n";
      card += "sig_"+chstr+"_8TeV_alpha_err_scaledn-e     param    0    SIG_"+chstr+"_8TeV_alpha_err_scaledn-e   [-3,3]    \n";
      card += "sig_"+chstr+"_8TeV_n_err_scaledn-e         param    0    SIG_"+chstr+"_8TeV_n_err_scaledn-e       [-3,3]    \n";
      card += "sig_"+chstr+"_8TeV_mean_err_scaleup-m      param    0    SIG_"+chstr+"_8TeV_mean_err_scaleup-m    [-3,3]    \n";
      card += "sig_"+chstr+"_8TeV_sigma_err_scaleup-m     param    0    SIG_"+chstr+"_8TeV_sigma_err_scaleup-m   [-3,3]    \n";
      card += "sig_"+chstr+"_8TeV_alpha_err_scaleup-m     param    0    SIG_"+chstr+"_8TeV_alpha_err_scaleup-m   [-3,3]    \n";
      card += "sig_"+chstr+"_8TeV_n_err_scaleup-m         param    0    SIG_"+chstr+"_8TeV_n_err_scaleup-m       [-3,3]    \n";
      card += "sig_"+chstr+"_8TeV_mean_err_scaledn-m      param    0    SIG_"+chstr+"_8TeV_mean_err_scaledn-m    [-3,3]    \n";
      card += "sig_"+chstr+"_8TeV_sigma_err_scaledn-m     param    0    SIG_"+chstr+"_8TeV_sigma_err_scaledn-m   [-3,3]    \n";
      card += "sig_"+chstr+"_8TeV_alpha_err_scaledn-m     param    0    SIG_"+chstr+"_8TeV_alpha_err_scaledn-m   [-3,3]    \n";
      card += "sig_"+chstr+"_8TeV_n_err_scaledn-m         param    0    SIG_"+chstr+"_8TeV_n_err_scaledn-m       [-3,3]    \n";
      card += "sig_"+chstr+"_8TeV_mean_err_scaleup-j      param    0    SIG_"+chstr+"_8TeV_mean_err_scaleup-j    [-3,3]    \n";
      card += "sig_"+chstr+"_8TeV_sigma_err_scaleup-j     param    0    SIG_"+chstr+"_8TeV_sigma_err_scaleup-j   [-3,3]    \n";
      card += "sig_"+chstr+"_8TeV_alpha_err_scaleup-j     param    0    SIG_"+chstr+"_8TeV_alpha_err_scaleup-j   [-3,3]    \n";
      card += "sig_"+chstr+"_8TeV_n_err_scaleup-j         param    0    SIG_"+chstr+"_8TeV_n_err_scaleup-j       [-3,3]    \n";
      card += "sig_"+chstr+"_8TeV_mean_err_scaledn-j      param    0    SIG_"+chstr+"_8TeV_mean_err_scaledn-j    [-3,3]    \n";
      card += "sig_"+chstr+"_8TeV_sigma_err_scaledn-j     param    0    SIG_"+chstr+"_8TeV_sigma_err_scaledn-j   [-3,3]    \n";
      card += "sig_"+chstr+"_8TeV_alpha_err_scaledn-j     param    0    SIG_"+chstr+"_8TeV_alpha_err_scaledn-j   [-3,3]    \n";
      card += "sig_"+chstr+"_8TeV_n_err_scaledn-j         param    0    SIG_"+chstr+"_8TeV_n_err_scaledn-j       [-3,3]    \n";
