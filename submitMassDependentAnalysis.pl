...
#     system("python cmst3_submit_manyfilesperjob.py Spring11_V2 WToTauNu_TuneZ2_7TeV-pythia6-tauola 5 HiggsApp 8nh $fullprefix 1");
    ...
    system("python cmst3_submit_manyfilesperjob.py Spring11_V2 DYToTauTau_M-20_TuneZ2_7TeV-pythia6 5 HiggsApp 8nh $fullprefix 1");
    ...
    system("python cmst3_submit_manyfilesperjob.py Spring11_V2 DYToTauTau_M-10To20_TuneZ2_7TeV-pythia6 5 HiggsApp 8nh $fullprefix 1");
