...
void estimateDY() {
  ...
  int njets = 0; // do estimation for bin 0/1
  ...
  treeZjets->Project("ZeejetsH","deltaPhi",(TString("(")+TString(wwselcut)+TString(" && finalstate==0)*weight*puweight")).Data());
  treeZjets->Project("ZmmjetsH","deltaPhi",(TString("(")+TString(wwselcut)+TString(" && finalstate==1)*weight*puweight")).Data());
  treeZjets->Project("ZemjetsH","deltaPhi",(TString("(")+TString(wwselcut)+TString(" && finalstate==2)*weight*puweight")).Data());
  treeZjets->Project("ZmejetsH","deltaPhi",(TString("(")+TString(wwselcut)+TString(" && finalstate==3)*weight*puweight")).Data());
  ...
  treeOthers->Project("OthersEEH","deltaPhi",(TString("(finalLeptons && pfMet>20 && projMet>35 &&")+TString(njcut)+TString(" && bTagTrackCount<2.1 && abs(eleInvMass-91.1876)<15 && finalstate==0)*weight*puweight")).Data());
  treeOthers->Project("OthersMMH","deltaPhi",(TString("(finalLeptons && pfMet>20 && projMet>35 &&")+TString(njcut)+TString(" && bTagTrackCount<2.1 && abs(eleInvMass-91.1876)<15 && finalstate==1)*weight*puweight")).Data());
  
  treeData->Project("neeInH","deltaPhi",(TString("eleInvMass>12 && finalLeptons && pfMet>20 && projMet>35 && ")+TString(njcut)+TString(" && bTagTrackCount<2.1 && abs(eleInvMass-91.1876)<15 && finalstate==0")).Data()); // missing softmu... not available in red trees... hopefully small contrib here
  treeData->Project("nmmInH","deltaPhi",(TString("eleInvMass>12 && finalLeptons && pfMet>20 && projMet>35 && ")+TString(njcut)+TString(" && bTagTrackCount<2.1 && abs(eleInvMass-91.1876)<15 && finalstate==1")).Data()); // missing softmu... not available in red trees... hopefully small contrib here
  treeData->Project("nemInH","deltaPhi",(TString("eleInvMass>12 && finalLeptons && pfMet>20 && projMet>35 && ")+TString(njcut)+TString(" && bTagTrackCount<2.1 && abs(eleInvMass-91.1876)<15 && (finalstate==2 || finalstate==3)")).Data()); // missing softmu... not available in red trees... hopefully small contrib here
  ...
  std::cout << "My estimation of R and k: " << std::endl;
  ...
  // ee and mm from data
  float neeExp = (nDYout(neeIn, nemIn, R[ee], R_err[ee], k[ee], k_err[ee], nOthers[ee])).first;
  float neeExp_err = (nDYout(neeIn, nemIn, R[ee], R_err[ee], k[ee], k_err[ee], nOthers[ee])).second;
  float nmmExp = (nDYout(nmmIn, nemIn, R[mm], R_err[mm], k[mm], k_err[mm], nOthers[mm])).first;
  float nmmExp_err = (nDYout(nmmIn, nemIn, R[mm], R_err[mm], k[mm], k_err[mm], nOthers[mm])).second;
