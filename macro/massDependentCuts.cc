...
TString higgsCuts(int mH, bool out, int njets) {
  ...
  cuts.insert(std::make_pair(125,dymvacut + TString(" && pt1>23 dphill*180./TMath::Pi()<103 &&  mth>80  &&  mth<123")));
  ...
  cuts.insert(std::make_pair(145,dymvacut + TString(" && pt1>26 && pt2>15 && dphill*180./TMath::Pi()<90  &&  mth>80  &&  mth<140")));
  ...
  cuts.insert(std::make_pair(600,finalmetcut + TString(" && pt1>140 && pt>25 && dphill*180./TMath::Pi()<175 &&  mth>120 &&  mth<600")));
  cuts.insert(std::make_pair(700,finalmetcut + TString(" && pt1>150 && pt>25 && dphill*180./TMath::Pi()<175 &&  mth>120 &&  mth<700")));
  cuts.insert(std::make_pair(800,finalmetcut + TString(" && pt1>160 && pt>25 && dphill*180./TMath::Pi()<175 &&  mth>120 &&  mth<800")));
  cuts.insert(std::make_pair(900,finalmetcut + TString(" && pt1>170 && pt>25 && dphill*180./TMath::Pi()<175 &&  mth>120 &&  mth<900")));
...
TString higgsCutsNoMT(int mH, bool out, int njets) {
  ...
  cuts.insert(std::make_pair(125,dymvacut + TString(" && pt1>23 dphill*180./TMath::Pi()<103")));
  ...
  cuts.insert(std::make_pair(145,dymvacut + TString(" && pt1>26 && pt2>15 && dphill*180./TMath::Pi()<90")));
  ...
  cuts.insert(std::make_pair(600,finalmetcut + TString(" && pt1>140 && pt>25 && dphill*180./TMath::Pi()<175")));
  cuts.insert(std::make_pair(700,finalmetcut + TString(" && pt1>150 && pt>25 && dphill*180./TMath::Pi()<175")));
  cuts.insert(std::make_pair(800,finalmetcut + TString(" && pt1>160 && pt>25 && dphill*180./TMath::Pi()<175")));
  cuts.insert(std::make_pair(900,finalmetcut + TString(" && pt1>170 && pt>25 && dphill*180./TMath::Pi()<175")));
