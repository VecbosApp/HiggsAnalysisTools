...
TString higgsCutsBDT(int mH, bool out, int njets) {
  ...
  cuts.insert(std::make_pair(125,dymvacut + TString(" &&  mth>80 && mth<124")));
  ...
  cuts.insert(std::make_pair(145,finalmetcut + TString(" &&  mth>80 && mth<140")));
  ...
  cutsOut.insert(std::make_pair(125,cuts[125]+TString(" && mll<70")));
