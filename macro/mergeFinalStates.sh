...
do
  hadd -f results/datasets_trees/H$i\_ll.root results/datasets_trees/H$i\_ee.root results/datasets_trees/H$i\_mm.root results/datasets_trees/H$i\_em.root results/datasets_trees/H$i\_me.root
done
