...
#include "kFactorEvaluator.hh"
#include "HiggsSelection.hh"
...
void HiggsSelection::Loop() {
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++) {
	 ...
	 !foundMcTree ) continue;              
      ...
      if(_selection->getSwitch("trigger") && 
	 !(singleElePassedTrg) && !(singleEleRelaxPassedTrg) &&
	 !(doubleElePassedTrg) && !(doubleEleRelaxPassedTrg) ) continue;                      
